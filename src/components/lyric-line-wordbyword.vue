<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateActiveLines() {
                // 获取当前音频播放的时间
                const currentTime = this.audioDom.currentTime+0.2;
        ...
        created() {
            this.$nextTick(() => {
                ...
                this.updateActiveLinesIntervalID = setInterval(this.updateActiveLines, 1000/48)
            });
        },
        beforeDestroy() {
            // 清除定时器，防止内存泄漏
...
<style scoped>
    .yrcLine {
        ...
        --background-transition-linear-gradient-progress-width: 0.5em !important;
